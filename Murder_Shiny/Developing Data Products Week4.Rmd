...
write.csv(murderTotals,file="MurderTotals.csv",row.names =  FALSE, quote = TRUE)
write.csv(latlng,file="LatLng.csv",row.names =  FALSE, quote = TRUE)
#murderLocation <- merge(byCity,latlng,by=c("City","State"),all.x = TRUE)
#murderLocTotals <- aggregate(Victim.Count ~ City+State,murderLocation,sum)
#murderLocation[is.na(murderLocation$lat),]
# murderTotals <- murderTotals[murderTotals$Year > 1990,]
# murderTotals <- murderTotals[murderTotals$Year < 1995,]
# murderTotals <- murderTotals[murderTotals$State=="AZ" ,]
# View(murderTotals)
#murderLocation[is.na(murderLocation$lat),]
